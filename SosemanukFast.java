/**
 * <p>
 * SOSEMANUK implementation, fast version. This implementation tries to
 * optimize runtime performance at the expense of code readability.
 * </p>
 *
 * <p>
 * Usage: set the key with <code>setKey()</code>, then the IV with
 * <code>setIV()</code>; the object is ready to produce stream bytes
 * through the <code>makeStream()</code> method. Both the key and IV
 * can be reset arbitrarily.
 * </p>
 *
 *
 * <p>
